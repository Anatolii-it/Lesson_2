...
int main() {
    ...
    if ((happy > p2)&&(happy>p3)) {
        cout << "Ігор 1 місце отримає  премію + 200 ітого " << p1 + 200 << " $" << endl;
        if (p2 > p3) {
            cout << "Діма 2 місце отримає " << p2 << endl;
            cout << "Олег 3 місце отримає " << p3 << endl;
        }
        else {
            cout << "Олег 2 місце отримає " << p3 << endl;
            cout << "Діма 3 місце отримає " << p2 << endl;
        }
    }
    else {
    ...
    if ((happy > p1) && (happy > p3)) {
        ...
        if (p1 > p3) {
            cout << "Ігор 2 місце отримає " << p1 << endl;
            cout << "Олег 3 місце отримає " << p3 << endl;
        }
        else {
            cout << "Олег 2 місце отримає " << p3 << endl;
            cout << "Ігор 3 місце отримає " << p1 << endl;
        }
